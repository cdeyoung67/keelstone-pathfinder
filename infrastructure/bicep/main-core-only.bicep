...
var tags = {
  ...
  ManagedBy: 'Bicep'
  DeploymentMethod: 'Core-Infrastructure'
}
...
module functions 'modules/functions.bicep' = {
  ...
  params: {
    ...
    openAIEndpoint: '' // Will be added later
    openAIKey: '' // Will be added later
...
// Outputs for reference and manual CI/CD setup
...
output deploymentSummary object = {
  ...
  environment: environment
  location: location
  deploymentMethod: 'Core-Infrastructure-Only'
}

// Instructions for next steps
output nextSteps array = [
  'Deploy Azure Functions code using: az functionapp deployment source config-zip'
  'Create Static Web App manually or via GitHub Actions'
  'Configure frontend environment variables with Function App URL'
  'Test the deployed APIs using the provided URLs'
]
